...
const ACTION_META: Record<string, { label: string; color: string }> = {
  ...
  'aid.create':             { label: 'طلب معونة',          color: 'text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30' },
  'aid.status_change':      { label: 'تحديث معونة',        color: 'text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30' },
